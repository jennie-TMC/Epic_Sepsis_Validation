...
create.figure <- function(measures=NULL, threshold=0.5, predictions=NULL,
  ...
  abline(h=seq(min.pred, 1, 0.125), lty=1, col= gray(0.5, alpha=0.4))
  abline(v=seq(min.pred, 1, 0.125), lty=1, col= gray(0.5, alpha=0.4))
  rect(threshold, 0, 1, 1, col=gray(0.8, alpha=0.4), border=NA)
